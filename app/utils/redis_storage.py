...
class RedisStorage:
    """Redis storage for FSM, post drafts, and scheduling"""
    ...
    async def update_session(self, user_id: int, ttl: int = 600) -> bool:
        """
        ...
        try:
            ...
            await self.redis.setex(key, ttl, datetime.now().isoformat())
            return True
        except Exception as e:
